...
public class MainActivity extends ActionBarActivity {
    ...
    //Action bar to select play RTSP address, seek, and show tips
    private ActionBar mActionBar;
    //sliding menu, to select different types
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	/*if no compatible CPU, turn to CompatErrorActivity */
        ...
        //View, not the core player function
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //Change menu offset according to the width and height of display
        changeMenuOffset();
    }
    ...
    //get MediaRealPlayer location from EditText
    private void onOpenMRL() {
        ...
        b.setPositiveButton(R.string.open, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int button) {
            	...
            	//Get into VLC callback task in org.videolan.vlc package
                VLCCallbackTask task = new VLCCallbackTask(MainActivity.this)
                {
                    @Override
                    public void run() {
                    	//Create a new Audio service controller 
